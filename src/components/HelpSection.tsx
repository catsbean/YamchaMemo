      ...
      <Topic title="노트끼리 잇기">
        ...
        <Ul
          items={[
            ...
            "제목을 바꾸면 그 노트를 가리키던 링크도 함께 따라갑니다.",
          ]}
        />
        <p>
        ...
        <p>
          ...
          링크를 눌렀을 때 <B>어느 글인지 고르는 창</B>이 뜹니다. 늘 한쪽으로 가게
          하려면 링크에 폴더를 함께 적으세요 — <Code>[[회의록/중복노트]]</Code>.{" "}
      ...
      <Topic title="이럴 땐">
        <Dl
          items={[
            ...
            ["노트를 다른 분류로 옮기고 싶다", "목록에서 우클릭해 [○○(으)로 이동], 또는 노트를 열고 오른쪽 위 [이동]. 도서리스트·데일리노트는 파일명 규칙이 정해져 있어 옮길 수 없습니다."],
